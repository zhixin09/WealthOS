                    ...
                    <div className="space-y-0.5 px-6">
                        {transactions.slice(0, 10).map((txn) => {
                            ...
                            return (
                                ...
                                >
                                    <div className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent ${config.color}`}>
                                    ...
                                    <div className="text-right">
                                        <p
                                            className={`text-sm font-semibold ${isDebit ? "text-rose" : "text-emerald"
                                                }`}
                                        >
                                            {isDebit ? "-" : "+"}$
